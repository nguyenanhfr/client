(function() {
	...
	DineInController.$inject = [
		...
		'restaurantInfoService', '$ionicHistory', '$state',
		'deliveryDataService', 'phoneNumber', 'discount'];


	/* @ngInject */
	function DineInController(restaurantCartService, restaurantOrderProcessor,
	                          restaurantInfoService, $ionicHistory, $state,
	                          deliveryDataService, phoneNumber, discount) {
		...
		function confirm(form) {
			...
			restaurantOrderProcessor.sendDineInConfirmation(items, vm.restaurant, vm.data, discount)
